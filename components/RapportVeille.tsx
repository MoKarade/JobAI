...
import { LIBELLE_MOTIF, depuis, fraicheurSource, type RapportVeille } from "@/lib/rapportVeille";
...
export function RapportVeilleVue({
  ...
  // ⚠️ AVANT LES CHIFFRES, PARCE QU'ELLE CHANGE LEUR SENS. « 0 nouvelle » sur une source fraîche
  // est une observation du marché ; sur une source qui rouille, c'est l'absence d'observation.
  const fraicheur = fraicheurSource(rapport.fraicheur);
