...
| [0023](./0023-une-table-d-alias-fermee-pour-les-employeurs-deja-rencontres.md) | Une table d'alias FERMÉE pour les employeurs déjà rencontrés | Accepté (Marc, 2026-09-21) — implémenté le jour même |
