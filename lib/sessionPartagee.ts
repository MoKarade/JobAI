...
// `emploi.hubperso.com` ne l'enverrait jamais à `carai.hubperso.com`. En lui déclarant
...
// silencieusement : le cookie n'est pas posé, on retombe sur /connexion en boucle, sans
...
//
// Fichier IDENTIQUE dans Hubperso, CarAI et BatchChef. Documentation commune :
